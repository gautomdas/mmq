...
class GQAEval(Dataset):
    ...
    """
    def __init__(self, image_root, q_root, img_transform=None, text_processor=None, prompt=None):
    ...
    def collater(self, samples):
        ...
        return {"question_id": question_ids, "image": images, "text_input": questions, "gt_answer": gt_answers}
