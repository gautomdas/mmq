...
from scaled_modules import ScaledModule
from utils import *
    ...
    def _group_modules_for_scaling(self, layer, linear_inputs, layer_group):
        ...
        # TODO: verify this
            ...
            if hasattr(layer, 'crossattention'):
                 # Qformer cross-attn QKV
                grouped_mods.append(
                    dict(
                        prev_op = 'crossattention.attention',
                        modules = [
                        ...
                        parent_module = layer.crossattention.attention,
                        layer_args = self.layer_args[layer_group],
                        layer_kwargs = self.layer_kwargs[layer_group]
                    )
                )
