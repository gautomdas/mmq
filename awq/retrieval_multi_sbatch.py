...
# print(f"Starting a batch of {args.batchsize} from offset {args.offset}")
params = {
    # 'config_file': ['', '', [f'./configs/{i}.json' for i in range(args.offset, args.batchsize+args.offset)]]
    'config_path': ['--config_path', 'config_path', [f'retrieval_configs/awq_{i}' for i in range(7**2)]],
    'task': ['--task', 'task', ['image_text_retrieval']]
}
#######################################################################
