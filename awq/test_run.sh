...
#SBATCH --job-name=blip2_awq_test                    # sets the job name
#SBATCH --output=blip2_awq_test.%j                    # indicates a file to redirect STDOUT to; %j is the jobid. If set, must be set to a file instead of a directory or else submission will fail.
#SBATCH --error=blip2_awq_test.%j                     # indicates a file to redirect STDERR to; %j is the jobid. If set, must be set to a file instead of a directory or else submission will fail.
